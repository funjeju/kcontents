...
function buildPrompt(params: {
  ...
  switch (source) {
    case "drama":
      ...
      sourceInstruction = `[드라마 시나리오 원칙]
이 드라마를 실제로 알고 있다면, 원작의 실제 시대 배경·핵심 사건·감정 구조·이야기 흐름을 최대한 충실하게 반영하세요.
단, 실존 캐릭터의 고유명사(이름)는 직접 사용하지 말고 역할 원형으로 표현하세요.
예: 캐릭터 이름 대신 "재벌가 딸", "검사 출신 남자", "숨겨진 진실을 아는 여자" 등으로 표현.
이야기의 핵심 갈등, 시대, 반전 구조는 원작을 따라가되 대사와 고유명사만 피하면 됩니다.`;
      break;
