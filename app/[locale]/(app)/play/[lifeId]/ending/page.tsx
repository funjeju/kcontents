    ...
    <div className="min-h-dvh bg-bg flex flex-col">
      <div className="flex-1 flex flex-col max-w-game mx-auto w-full px-screen-x py-10">
        ...
        >
          <div className="flex flex-col items-center gap-2">
            <span className="text-xs text-accent-gold tracking-widest uppercase font-medium">
              희귀 결말 — {MOCK_ENDING.rarityPercentage}%
            </span>
        ...
        >
          ...
          <p className="text-text-muted text-sm mt-2">{MOCK_ENDING.shortDescription}</p>
        </motion.div>
        ...
        >
          {MOCK_ENDING.endingNarrative.split("\n\n").map((para, i) => (
        ...
        >
          ...
          <div className="flex flex-wrap gap-1.5">
            {Object.entries(MOCK_ENDING.stats).map(([key, val]) => (
